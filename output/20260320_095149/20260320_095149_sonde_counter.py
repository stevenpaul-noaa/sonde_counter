...
2026-03-20 SCP: All output files (timestamped and latest copies, zip) are
               written to a timestamped subfolder, keeping the script
               directory clean.
...
def load_aliases(aliases):
    ...
    o=open(os.path.join(out_dir, startscript+'_counter_aliases_out.txt'),'w')
    oo=open(os.path.join(out_dir, startscript+'_counter_dropper_names.txt'),'w')
    ooo=open(os.path.join(out_dir, startscript+'_counter_aliases_sorted.txt'),'w')
...
# Create a timestamped output subfolder next to this script so the
# script directory stays clean (only sonde_counter.py + counter_aliases.txt).
script_dir = os.path.dirname(os.path.abspath(sys.argv[0]))
out_dir = os.path.join(script_dir, 'output', startscript)
os.makedirs(out_dir, exist_ok=True)
print("OUTPUT DIR:   " + out_dir)

copied_script_path = os.path.join(out_dir, startscript + '_' + os.path.basename(sys.argv[0]))
...
outfile=open(os.path.join(out_dir, startscript+'_counter_all_drops.txt'),'w')
...
outfile=open(os.path.join(out_dir, startscript+'_counter_bad_files.txt'),'w')
badfiles.sort()
...
outfile=open(os.path.join(out_dir, startscript+'_counter_duplicates.txt'),'w')
dupefiles.sort()
...
outfile=open(os.path.join(out_dir, startscript+'_counter_summary.txt'),'w')
outfile.write("\n")
outfile.write("-----------------------\n")
...
outfile=open(os.path.join(out_dir, startscript+'_counter_totals_fy.txt'),'w')
outfile.write("\n")
outfile.write("----------------------------\n")
...
outfile=open(os.path.join(out_dir, startscript+'_counter_totals_cy.txt'),'w')
outfile.write("\n")
outfile.write("------------------------------\n")
...
# Helper so zip archive entries use bare filenames (no subfolder path inside the zip)
def _p(name):
    return os.path.join(out_dir, name)

zip_path = os.path.join(out_dir, startscript+".zip")
ZipFile = zipfile.ZipFile(zip_path, "w")
ZipFile.write('counter_aliases.txt', arcname='counter_aliases.txt',
              compress_type=zipfile.ZIP_DEFLATED)
ZipFile.write(_p(startscript+'_counter_aliases_out.txt'),
              arcname=startscript+'_counter_aliases_out.txt',    compress_type=zipfile.ZIP_DEFLATED)
ZipFile.write(_p(startscript+'_counter_aliases_sorted.txt'),
              arcname=startscript+'_counter_aliases_sorted.txt', compress_type=zipfile.ZIP_DEFLATED)
ZipFile.write(_p(startscript+'_counter_dropper_names.txt'),
              arcname=startscript+'_counter_dropper_names.txt',  compress_type=zipfile.ZIP_DEFLATED)
ZipFile.write(_p(startscript+'_counter_all_drops.txt'),
              arcname=startscript+'_counter_all_drops.txt', compress_type=zipfile.ZIP_DEFLATED)
ZipFile.write(_p(startscript+'_counter_bad_files.txt'),
              arcname=startscript+'_counter_bad_files.txt',      compress_type=zipfile.ZIP_DEFLATED)
ZipFile.write(_p(startscript+'_counter_duplicates.txt'),
              arcname=startscript+'_counter_duplicates.txt',     compress_type=zipfile.ZIP_DEFLATED)
ZipFile.write(_p(startscript+'_counter_summary.txt'),
              arcname=startscript+'_counter_summary.txt',        compress_type=zipfile.ZIP_DEFLATED)
ZipFile.write(_p(startscript+'_counter_totals_fy.txt'),
              arcname=startscript+'_counter_totals_fy.txt',      compress_type=zipfile.ZIP_DEFLATED)
ZipFile.write(_p(startscript+'_counter_totals_cy.txt'),
              arcname=startscript+'_counter_totals_cy.txt',      compress_type=zipfile.ZIP_DEFLATED)
ZipFile.write(copied_script_path,
              arcname=os.path.basename(copied_script_path),      compress_type=zipfile.ZIP_DEFLATED)
ZipFile.close()

# Write the un-timestamped "latest" copies into the same output subfolder.
# The script directory is left with only sonde_counter.py + counter_aliases.txt.
copyfile(_p(startscript+'_counter_dropper_names.txt'),  _p('counter_dropper_names.txt'))
copyfile(_p(startscript+'_counter_aliases_out.txt'),    _p('counter_aliases_out.txt'))
copyfile(_p(startscript+'_counter_aliases_sorted.txt'), _p('counter_aliases_sorted.txt'))
copyfile(_p(startscript+'_counter_all_drops.txt'), _p('counter_all_drops.txt'))
copyfile(_p(startscript+'_counter_all_drops.txt'), os.path.join(script_dir, 'counter_all_drops.txt'))
copyfile(_p(startscript+'_counter_bad_files.txt'),      _p('counter_bad_files.txt'))
copyfile(_p(startscript+'_counter_duplicates.txt'),     _p('counter_duplicates.txt'))
copyfile(_p(startscript+'_counter_summary.txt'),        _p('counter_summary.txt'))
copyfile(_p(startscript+'_counter_totals_fy.txt'),      _p('counter_totals_fy.txt'))
copyfile(_p(startscript+'_counter_totals_cy.txt'),      _p('counter_totals_cy.txt'))

os.remove(_p(startscript+'_counter_aliases_out.txt'))
os.remove(_p(startscript+'_counter_aliases_sorted.txt'))
os.remove(_p(startscript+'_counter_dropper_names.txt'))
os.remove(_p(startscript+'_counter_all_drops.txt'))
os.remove(_p(startscript+'_counter_bad_files.txt'))
os.remove(_p(startscript+'_counter_duplicates.txt'))
os.remove(_p(startscript+'_counter_summary.txt'))
os.remove(_p(startscript+'_counter_totals_fy.txt'))
os.remove(_p(startscript+'_counter_totals_cy.txt'))
